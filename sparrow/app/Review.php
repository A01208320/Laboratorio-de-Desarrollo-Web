...
class Review extends Model
{
    ...
    static public function getReviews(int $user_id)
    {
        return Review::where('user_id', $user_id)
            ...
            ->select('title_user.id', 'titles.name AS title_name', 'platforms.name AS platform_name', 'titles.edition', 'title_user.recomendation', 'title_user.comment', 'users.name AS user_name', 'users.email', 'title_user.created_at');
    }
